        ...
        <Body style={main}>
          ...
          <Container style={container}>
            <Section>
              ...
              >
                {firstName?.split(" ")?.[0] || firstName}, Good Night ☀️
              </Text>
              <Text style={text}>
                Here is your evening report so you can be current before
                sleeping.
              </Text>
            </Section>
            <Section>
            ...
            <Hr />
            <Section>
              <Text style={sectionHeader}>Tasks you completed today</Text>
              {completed.length > 0 ? (
                completed.map((task) => <Task task={task} noSubtitle />)
              ) : (
                <Text style={text}>You have no tasks completed today.</Text>
              )}
            </Section>
            <Hr />
            <Section>
              <Text style={sectionHeader}>Tasks to complete tomorrow</Text>
              {tomorrow.length > 0 ? (
                tomorrow.map((task) => <Task task={task} />)
              ) : (
                <Text style={text}>You have no tasks due tomorrow.</Text>
              )}
            </Section>
            <Hr />
            <Section>
